...
const version = (n: number): Version => ({ n, diseno: librero, resumen: `cambio ${n}`, motivo: `pedido ${n}`, operaciones: ['x→900 estirar'], fecha: '2026-09-24', origen: null, decisiones: [], plan: null, extras: [] })

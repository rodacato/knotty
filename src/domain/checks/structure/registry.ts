...
export const RULES = [
  ...
  defineRule({ code: 'R4_TIPPING', title: 'Riesgo de vuelco', version: 2, check: tippingRule }),
...
/** R1 and R4 are at 2: their reference values changed (step 21 of the proposal). */

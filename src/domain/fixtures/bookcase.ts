...
export const exampleBookcase: Design = {
  ...
  joints: [
    ...
    makeJoint('u-techo-izq', 'lat-izq', 'techo', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-techo-der', 'lat-der', 'techo', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-zoclo-izq', 'zoclo', 'lat-izq', 'pocket-screw', [{ hardwareId: 'tornillo-bolsillo-1-1/4', count: 2 }]),
    makeJoint('u-zoclo-der', 'zoclo', 'lat-der', 'pocket-screw', [{ hardwareId: 'tornillo-bolsillo-1-1/4', count: 2 }]),
    makeJoint('u-zoclo-piso', 'piso', 'zoclo', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    ...
    ...entrepanos.flatMap((e) =>
      ['lat-izq', 'lat-der'].map((lat) => makeJoint(`u-${e.id}-${lat}`, e.id, lat, 'shelf-pin', [{ hardwareId: 'soporte-repisa-5', count: 2 }])),
    ),
  ],
}

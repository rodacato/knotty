...
export const exampleNightstand: Design = {
  ...
  joints: [
    makeJoint('u-techo-izq', 'techo', 'lat-izq', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-techo-der', 'techo', 'lat-der', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-piso-izq', 'lat-izq', 'piso', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-piso-der', 'lat-der', 'piso', 'butt-screw', [{ hardwareId: 'tornillo-8x2', count: null }]),
    makeJoint('u-entrepano-izq', 'entrepano', 'lat-izq', 'dowel', [{ hardwareId: 'tarugo-8x40', count: 3 }]),
    makeJoint('u-entrepano-der', 'entrepano', 'lat-der', 'dowel', [{ hardwareId: 'tarugo-8x40', count: 3 }]),
    ...['lat-izq', 'lat-der', 'piso', 'techo', 'entrepano'].map((b) => makeJoint(`u-trasera-${b}`, 'trasera', b, 'glue-nail', [{ hardwareId: 'clavo-sin-cabeza-1', count: null }])),
    makeJoint('u-puerta', 'puerta', 'lat-izq', 'cup-hinge', [{ hardwareId: 'bisagra-cazoleta-35-recta', count: 2 }]),
  ],
}

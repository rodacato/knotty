...
describe('describeChange', () => {
  it('lists removed pieces as direct changes', () => {
    const after = apply(exampleBookcase, [{ op: 'eliminarPieza', id: 'entrepano-2' }, { op: 'eliminarPieza', id: 'entrepano-3' }])
  ...
  it('a wider piece of furniture is a size change; the pieces only follow along', () => {
    const after = apply(exampleBookcase, [{ op: 'cambiarDimensionGlobal', eje: 'x', valor: 800, regla: 'estirar' }])
  ...
  it('says how a changed piece changed', () => {
    const after = apply(exampleBookcase, [{ op: 'cambiarEspesor', ids: ['entrepano-1'], material: 'T15' }])
...
describe('restorePieces', () => {
  it('brings back removed shelves with their supports, and keeps what came after', () => {
    const removed = apply(exampleBookcase, [{ op: 'eliminarPieza', id: 'entrepano-2' }, { op: 'eliminarPieza', id: 'entrepano-3' }])
  ...
  it('reverts a changed piece and removes an added one', () => {
    const moved = apply(exampleBookcase, [{ op: 'cambiarEspesor', ids: ['entrepano-1'], material: 'T15' }, { op: 'duplicarPieza', id: 'entrepano-4', nuevoId: 'entrepano-5', nombre: 'Entrepaño 5', eje: 'y', cota: { tipo: 'mm', mm: 1500 } }])

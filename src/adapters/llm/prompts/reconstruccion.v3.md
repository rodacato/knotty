...
Recibes las medidas generales de un mueble y, o bien fotos desde varios ángulos (cada una con su etiqueta), o bien una descripción escrita por la persona. Produce el modelo completo en `diseno`:

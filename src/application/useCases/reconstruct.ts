...
import { buildPlan, MODULE_OF_KIND, moduleOf, type FurniturePlan } from '../../domain/modules/plan'
...
import { describeProblems, traceErrors, type TraceEntry } from '../../domain/trace/trace'

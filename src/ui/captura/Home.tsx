...
function Sketch() {
  const stroke = 'fill-none stroke-grafito/70 [stroke-width:1.4] [stroke-linejoin:round]'
  const wood = 'fill-pino/40 stroke-grafito/70 [stroke-width:1.4] [stroke-linejoin:round]'
  return (

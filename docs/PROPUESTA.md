...
Revisiones por tipo de mueble (`domain/typology`): alto de una mesa o un escritorio, espacio para las piernas, medidas de la cama contra el colchón, fondo de un librero, anclaje de lo que cuelga. Cada revisión es una entrada de `domain/typology/constraints.ts` con sus límites y su fuente en `docs/carpinteria`.
...
||||||| parent of 09c0f09 (Propuesta: paso 17, la ficha sale de los campos de su módulo)
